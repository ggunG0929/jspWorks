...
<jsp:useBean id="aB" class="address.AddrBook" />	<!-- AddrBook ctrl+space -->
...
<jsp:useBean id="abDAO" class="address.AddrBookDAO" scope="application" />	<!-- scope는 저장방식, 지우면 목록이 안불러와짐 -->
<%
